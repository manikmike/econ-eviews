...
%input1 = "op1231r_inc1inc2inc3"

%input2 = "op1231o_inc1inc2inc3"
...
wfopen C:\Users\{%username}\GitRepos\econ-eviews\{%input1}
wfselect work

copy {%input1}::a\pm20dicp a\temp
...
for !a = 15 to 66
   for %s m f
      genr n{%s}{!a}d = {%input1}.wf1::a\p{%s}{!a}dicp / 1000000
   next
next
...
for !a = 15 to 69
   for %s m f
      genr n{%s}{!a}di = {%input1}.wf1::a\p{%s}{!a}dins / 1000000
   next
next
...
copy work::a\n*d {%input2}::a\n*d
copy work::a\n*di {%input2}::a\n*di
copy work::a\r*di {%input2}::a\r*di
copy work::a\r*d {%input2}::a\r*d

delete *

pageselect q
copy work::q\r*di {%input2}::q\r*di
copy work::q\r*d {%input2}::q\r*d
