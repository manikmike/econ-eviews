...
' first input excel spreadsheet with exog data for pwswto brent twexbmth ru and pragfc ''updated for tr24 - oil prices, RU, ag commodity price index
...
string datef = "2022m11"
string datel = "2023m12"
...
' input expenditure shares and put in 05112 instead of 05111 for energy commod to make shares sume to exactly one '
smpl {ahyr} {eyr}
...
' input gdp shares '
smpl {ahyr} {hhyr}
series rpcegdp_q = 0.682143
series rgovgdp_q = 0.174552
series rpfigdp_q = 0.172193

series rimppetgdp_q = 0.009925

smpl {ahyr} {eyr}
series rimpxpetgdp_q = 0.104949
series rimpsergdp_q = 0.025642
series rxxppetgdp_q = 0.009942

series rxxpxpetgdp_q = 0.099374

' input pce shares '
series rgaspce_q = 0.023944
series rfoopce_q = 0.071952
series rpfipetpfi_q = 0.021600
...
' output1.save(t=csv) S:\LRECON\COLA\cpi23trout_AUGTEST
output1.save(t=csv) cpi23trout_AUGTEST
