' This program produces series needed for the check on the cpso68116 databank.
...
' The Excel spreadsheet is cpsoCheck_TR2017.xlsx
' The Excel spreadsheet compares civilian noninstitutional population and civilian labor force variables from the TR17 cpso68116.bnk to data newly downloaded from Census website and stored on a worksheet in same Excel file. It notes any differences between data imported from the cpso68116.bnk and the newly downloaded data from the Census site.
' 
...
dbopen(type=aremos) "e:\usr\ECON\EcoDev\dat\cpso68116.bnk"
wfcreate a 2015 2016
'pageselect a
'smpl 2015 2016
fetch(d=cpso68116) nf*.a  nm*.a lf*.a  lm*.a  
