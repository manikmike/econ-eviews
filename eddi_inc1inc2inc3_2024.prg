...
%filename1 = """C:\Users\" + %username + "\GitRepos\econ-eviews\Disability ICP_LR_for OP123_inc1inc2inc3.xlsx"""
...
import(mode="u") {%filename1} range=Hist&SR.inc1!$BD$3:$CY$54 byrow names=%pmdicp @smpl 1975 2022
show {%pmdicp}
                                                                                                                                                                                                                                                                                                                                         
import(mode="u") {%filename1} range=Hist&SR.inc1!$BD$65:$CY$116 byrow names=%pfdicp @smpl 1975 2022
show {%pfdicp}
                                                                                                                                                                                    
'Putting historical ICP data into workfiles op1231r_inc1inc2inc3.wf1, op1232r_inc1inc2inc3.wf1, op1233r_inc1inc2inc3.wf1
'ALTs I,II, and III

for !i = 1 to 3

logmsg Entering historical ICP data into op{!tr}{!i}r_inc1inc2inc3
wfopen op{!tr}{!i}r_inc1inc2inc3 
wfselect work
pageselect a
copy * op{!tr}{!i}r_inc1inc2inc3::a\*
wfselect op{!tr}{!i}r_inc1inc2inc3
wfsave(2) op{!tr}{!i}r_inc1inc2inc3
close op{!tr}{!i}r_inc1inc2inc3

next
logmsg
logmsg Historical ICP data SAVED to all 3 op123xr__inc1inc2in3 (raw) workfiles
...
import(mode="u") {%filename1} range=Hist&SR.inc1!$CZ$3:$DI$54 byrow names=%pmdicp @smpl 2023 2032
show {%pmdicp}

import(mode="u") {%filename1} range=Hist&SR.inc1!$CZ$65:$DI$116 byrow names=%pfdicp @smpl 2023 2032
show {%pfdicp}
...
import(mode="u") {%filename1} range=ALT1inc1!$BD$4:$DS$55 byrow names=%pmdicp @smpl 2033 2100
show {%pmdicp}

import(mode="u") {%filename1} range=ALT1inc1!$BD$77:$DS$128 byrow names=%pfdicp @smpl 2033 2100
show {%pfdicp}

logmsg
logmsg Finished pulling Alt 1 LR projected ICP data

'ALT1 - ICP SR and LR DATA LOADED INTO OP1231r_inc1inc2inc3 WORKFILE
logmsg Entering ALT1 ICP SR and LR data into op1231r_inc1inc2inc3
wfopen op1231r_inc1inc2inc3.wf1
wfselect work
pageselect a
copy * op1231r_inc1inc2inc3::a\*
wfselect op1231r_inc1inc2inc3
wfsave(2) op1231r_inc1inc2inc3.wf1
close op1231r_inc1inc2inc3
...
import(mode="u") {%filename1} range=Hist&SR.inc2!$CZ$3:$DI$54 byrow names=%pmdicp @smpl 2023 2032
show {%pmdicp}

import(mode="u") {%filename1} range=Hist&SR.inc2!$CZ$65:$DI$116 byrow names=%pfdicp @smpl 2023 2032
show {%pfdicp}
...
import(mode="u") {%filename1} range=ALT2inc2!$BD$4:$DS$55 byrow names=%pmdicp @smpl 2033 2100
show {%pmdicp}

import(mode="u") {%filename1} range=ALT2inc2!$BD$78:$DS$129 byrow names=%pfdicp @smpl 2033 2100
show {%pfdicp}

logmsg
logmsg Finished pulling Alt 2 LR projected ICP data

'ALT2 - ICP SR and LR DATA LOADED INTO OP1232r_inc1inc2inc3 workfile
logmsg Entering ALT2 ICP SR and LR data into op1232r_inc1inc2inc3

wfopen op1232r_inc1inc2inc3.wf1
wfselect work
pageselect a
copy(m) * op1232r_inc1inc2inc3::a\*
wfselect op1232r_inc1inc2inc3
wfsave(2) op1232r_inc1inc2inc3.wf1
close op1232r_inc1inc2inc3
...
import(mode="u") {%filename1} range=Hist&SR.inc3!$CZ$3:$DI$54 byrow names=%pmdicp @smpl 2023 2032
show {%pmdicp}

import(mode="u") {%filename1} range=Hist&SR.inc3!$CZ$65:$DI$116 byrow names=%pfdicp @smpl 2023 2032
show {%pfdicp}
...
import(mode="u") {%filename1} range=ALT3inc3!$BD$4:$DS$55 byrow names=%pmdicp @smpl 2033 2100
show {%pmdicp}

import(mode="u") {%filename1} range=ALT3inc3!$BD$79:$DS$130 byrow names=%pfdicp @smpl 2033 2100
show {%pfdicp}

logmsg
logmsg Finished pulling Alt 3 LR projected ICP data

'ALT3 - ICP SR and LR DATA LOADED INTO OP1233r_inc1inc2inc3 (raw) WORKFILE
logmsg Entering ALT3 ICP data into op1233r_inc1inc2inc3
wfopen op1233r_inc1inc2inc3.wf1
wfselect work
pageselect a
copy(m) * op1233r_inc1inc2inc3::a\*
wfselect op1233r_inc1inc2inc3
wfsave(2) op1233r_inc1inc2inc3.wf1
close op1233r_inc1inc2inc3
...
logmsg  All ICP Data loaded into op123xr_inc1inc2inc3 (raw) databanks - All  3 Alts
...
'HISTORICAL INS DATA LOADED INTO OP123xr_inc1inc2inc3 WORKFILE
'Putting historical data into workfiles op1231r_inc1inc2inc3.wf1, op1232r_inc1inc2inc3.wf1, op1233r_inc1inc2inc3.wf1
'ALTs I,II, and III

for !i = 1 to 3

logmsg Entering historical INS data into op{!tr}{!i}r_inc1inc2inc3
wfopen op{!tr}{!i}r_inc1inc2inc3 + ".wf1"
wfselect work
pageselect a
copy * op{!tr}{!i}r_inc1inc2inc3::a\*
wfselect op{!tr}{!i}r_inc1inc2inc3
...
logmsg
logmsg Historical INS data loaded into all 3 op123xr_inc1inc2inc3 workfiles
...
'ALT1 - PROJECTED INS DATA LOADED INTO OP1231r_inc1inc2inc3 WORKFILE
logmsg Entering ALT1 INS data into op1231r_inc1inc2inc3
wfopen op1231r_inc1inc2inc3
wfselect work
pageselect a
copy * op1231r_inc1inc2inc3::a\*
wfselect op1231r_inc1inc2inc3
wfsave(2) op1231r_inc1inc2inc3
close op1231r_inc1inc2inc3

delete *

logmsg
logmsg Alt 1 INS projected data loaded into op1231r_inc1inc2inc3 workfile
...
'ALT2 - PROJECTED INS DATA LOADED INTO OP1232r_inc1inc2inc3 WORKFILE
logmsg Entering ALT2 INS data into op12232r_inc1inc2inc3
wfopen op1232r_inc1inc2inc3
wfselect work
pageselect a
copy(m) * op1232r_inc1inc2inc3::a\*
wfselect op1232r_inc1inc2inc3
wfsave(2) op1232r_inc1inc2inc3
close op1232r_inc1inc2inc3

delete *

logmsg
logmsg Alt 2 INS projected data loaded into op1232r_inc1inc2inc3 workfile
...
'ALT3 - PROJECTED INS DATA LOADED INTO OP1233r_inc1inc2inc3 WORKFILE
logmsg Entering ALT3 INS data into op1233r_inc1inc2inc3
wfopen op1233r_inc1inc2inc3
wfselect work
pageselect a
copy(m) * op1233r_inc1inc2inc3::a\*
wfselect op1233r_inc1inc2inc3
wfsave(2) op1233r_inc1inc2inc3
close op1233r_inc1inc2inc3

delete *

logmsg
logmsg Alt 3 INS projected data loaded into op1233r_inc1inc2inc3 workfile
logmsg
logmsg  All INS Data loaded into op123xr_inc1inc2inc3 workfiles - All  3 Alts
