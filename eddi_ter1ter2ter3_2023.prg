...
%filename1 = """C:\Users\" + %username + "\GitRepos\econ-eviews\Disability ICP_LR_for OP122_ter1ter2ter3.xlsx"""
...
' Assign year of Trustees Report which corresponds to disability databank name
!tr = 122
...
import(mode="u") {%filename1} range=Hist&SR.ter1!$BD$3:$CX$54 byrow names=%pmdicp @smpl 1975 2021
show {%pmdicp}
                                                                                                                                                                                                                                                                                                                                         
import(mode="u") {%filename1} range=Hist&SR.ter1!$BD$65:$CX$116 byrow names=%pfdicp @smpl 1975 2021
show {%pfdicp}
                                                                                                                                                                                    
'Putting historical ICP data into databanks op1221r_ter1ter2ter3.bnk, op1222r_ter1ter2ter3.bnk, op1223r_ter1ter2ter3.bnk
'ALTs I,II, and III

for !i = 1 to 3

   logmsg Entering historical ICP data into op{!tr}{!i}r_ter1ter2ter3
   db(type=aremos) op{!tr}{!i}r_ter1ter2ter3
store *
close @db
next
logmsg
logmsg Historical ICP data SAVED to all 3 op122xr (raw) banks

'Putting PROJECTED ICP data into op databanks.
...
import(mode="u") {%filename1} range=Hist&SR.ter1!$CY$3:$DH$54 byrow names=%pmdicp @smpl 2022 2031
show {%pmdicp}

import(mode="u") {%filename1} range=Hist&SR.ter1!$CY$65:$DH$116 byrow names=%pfdicp @smpl 2022 2031
show {%pfdicp}
...
import(mode="u") {%filename1} range=ALT1ter1!$BM$4:$EC$55 byrow names=%pmdicp @smpl 2032 2100
show {%pmdicp}

import(mode="u") {%filename1} range=ALT1ter1!$BM$78:$EC$129 byrow names=%pfdicp @smpl 2032 2100
show {%pfdicp}

logmsg
logmsg Finished pulling Alt 1 LR projected ICP data

'ALT1 - ICP SR and LR DATA LOADED INTO OP1221r_ter1ter2ter3 DATABANK
logmsg Entering ALT1 ICP SR and LR data into op1221r_ter1ter2ter3
dbopen(type=aremos) op1221r_ter1ter2ter3
store *
close @db

logmsg
logmsg All Alt 1 ICP projected data loaded into raw databank
...
import(mode="u") {%filename1} range=Hist&SR.ter2!$CY$3:$DH$54 byrow names=%pmdicp @smpl 2022 2031
show {%pmdicp}

import(mode="u") {%filename1} range=Hist&SR.ter2!$CY$64:$DH$115 byrow names=%pfdicp @smpl 2022 2031
show {%pfdicp}
...
import(mode="u") {%filename1} range=ALT2ter2!$BM$4:$EC$55 byrow names=%pmdicp @smpl 2032 2100
show {%pmdicp}

import(mode="u") {%filename1} range=ALT2ter2!$BM$78:$EC$129 byrow names=%pfdicp @smpl 2032 2100
show {%pfdicp}

logmsg
logmsg Finished pulling Alt 2 LR projected ICP data

'ALT2 - ICP SR and LR DATA LOADED INTO OP1222r DATABANK
logmsg Entering ALT2 ICP SR and LR data into op1222r_ter1ter2ter3
dbopen(type=aremos) op1222r_ter1ter2ter3
store *
close @db
...
import(mode="u") {%filename1} range=Hist&SR.ter3!$CY$3:$DH$54 byrow names=%pmdicp @smpl 2022 2031
show {%pmdicp}

import(mode="u") {%filename1} range=Hist&SR.ter3!$CY$63:$DH$114 byrow names=%pfdicp @smpl 2022 2031
show {%pfdicp}
...
import(mode="u") {%filename1} range=ALT3ter3!$BM$4:$EC$55 byrow names=%pmdicp @smpl 2032 2100
show {%pmdicp}

import(mode="u") {%filename1} range=ALT3ter3!$BM$78:$EC$129 byrow names=%pfdicp @smpl 2032 2100
show {%pfdicp}

logmsg
logmsg Finished pulling Alt 3 LR projected ICP data

'ALT3 - ICP SR and LR DATA LOADED INTO OP1223dr (raw) DATABANK
logmsg Entering ALT3 ICP data into op1223r_ter1ter2ter3
dbopen(type=aremos) op1223r_ter1ter2ter3
store *
close @db
close @wf
...
logmsg All Alt 3 ICP projected data loaded into raw databank
...
'HISTORICAL INS DATA LOADED INTO OP122xr DATABANKS
'Putting historical data into databanks op1221r_ter1ter2ter3.bnk, op1222r_ter1ter2ter3.bnk, op1223r_ter1ter2ter3.bnk
'ALTs I,II, and III

for !i = 1 to 3

   logmsg Entering historical INS data into op{!tr}{!i}r_ter1ter2ter3
   dbopen(type=aremos) op{!tr}{!i}r_ter1ter2ter3
store *
close @db
next
...
logmsg Entering ALT1 INS data into op1221r_ter1ter2ter3
dbopen(type=aremos) op1221r_ter1ter2ter3
store *
close @db
...
logmsg Entering ALT2 INS data into op1222r_ter1ter2ter3
dbopen(type=aremos) op1222r_ter1ter2ter3
store *
close @db
...
logmsg
logmsg Alt 2 INS projected data loaded into op1222r_ter1ter2ter3 databank
...
logmsg Entering ALT3 INS data into op1223r_ter1ter2ter3
dbopen(type=aremos) op1223r_ter1ter2ter3
store *
close @db
...
logmsg
logmsg Alt 3 INS projected data loaded into op1223r_ter1ter2ter3 databank
