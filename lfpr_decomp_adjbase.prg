...
' Indicate location of the databanks tp be used for the program run
'  IMPORTANT -- don't forget the "\" at the end of the folder path
' a-bank
%folder_a = "\\s1f906b\econ\Aremos\TR2017Banks\secret place\"
' d-bank
%folder_d = "\\s1f906b\econ\Aremos\TR2017Banks\secret place\"
'add-factor bank (ad-bank)
%folder_ad = "\\s1f906b\econ\Aremos\TR2017Banks\MKS\"
'op-bank
%folder_op = "\\s1f906b\econ\Aremos\TR2017Banks\MKS\"
...
%folder_output = "E:\usr\pvlasenk\LFPR Decomp Output\TR2017\"
...
'string variables that denote databanks, and the corresponding filepaths 
...
%abankpath=%folder_a+%abank+".bnk" 'full path to the databanks, including file extension
...
'create new page called "results" (annual from TRyr-1 to endyr) -- this is where the final LFPR decomposition tables will be stored
!tablestart = !TRyr-1 
!tableend = !endyr
...
'for Adjusted LFPRs, reset certain series to a constant value equat to the "base period"; for unadjusted LFPRs this step is skipped
if %lfpr="a" then 
...
delete *_c 
'delete pf* pm*  table_* -- I need LFPRs to compare to ASAs in the databank
...
'compare LFPRs produced by this program to those in the databank -- this is relevant only for the Adjusted LFPRs (Adjusted LFPRs in the databank use 2011 base, but in this file Adjusted LFPRs use base specified by user.
...
string line8 = "LFPR equation coefficicnts from " + %LFPRestimates
...
_summary.insert line1 line2 line3 line4 line5 line6 line7 line8 line9 line10
_summary.display
