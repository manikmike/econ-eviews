...
' This version of the program -- cps_popadj_factors_2023.prg -- adds the pop adjustment values released by BLS in Jan 2023 -- JA 05-19-2023
...
!yr_latest = 2023		' latest year, pop controls for which are being added to the workfile
' BLS file containing the raw numbers for 2023:  S:\LRECON\Data\Raw\CPS\PopAdjustments\2023_Pop_effects_based_on_Dec2022.pdf


' file that holds the existing popadj factors
%old_file = "cps_popadj_2022" 	' name only
...
{%vname}(1) = 954		'	n16o		(Table 1; also Table 2)
				
{%vname}(2) = 870		'	nm16o		(Table 1; also Table 2, total men)
{%vname}(3) = 17		'	nm1619		(Table 2, total men)
{%vname}(4) = 12		'	nm1617		(Table 2, total men)
{%vname}(5) = 5			'	nm1819		(Table 2, total men)
{%vname}(6) = 655		'	nm2024		(Table 2, total men)
{%vname}(7) = 607		'	nm2554		(Table 2, total men)
{%vname}(8) = 378		'	nm2534		(Table 2, total men)
{%vname}(9) = 131		'	nm3544		(Table 2, total men)
{%vname}(10) = 97		'	nm4554		(Table 2, total men)
{%vname}(11) = -100		'	nm5564		(Table 2, total men)
{%vname}(12) = -309		'	nm65o		(Table 2, total men)
				
{%vname}(13) = 84		'	nf16o		(Table 1; also Table 2, total women)
{%vname}(14) = -40		'	nf1619		(Table 2, total women)
{%vname}(15) = -25		'	nf1617		(Table 2, total women)
{%vname}(16) = -15		'	nf1819		(Table 2, total women)
{%vname}(17) = 550		'	nf2024		(Table 2, total women)
{%vname}(18) = -238		'	nf2554		(Table 2, total women)
{%vname}(19) = 24		'	nf2534		(Table 2, total women)
{%vname}(20) = -121		'	nf3544		(Table 2, total women)
{%vname}(21) = -141		'	nf4554		(Table 2, total women)
{%vname}(22) = -213		'	nf5564		(Table 2, total women)
{%vname}(23) = 25		'	nf65o		(Table 2, total women)
				
				
'Adjustment factors for Labor force...
{%vname}(24) = 871		'	l16o		(Table 1)
				
{%vname}(25) = 857		'	lm16o		(Table 1; also Table 2, total men)
{%vname}(26) = -1		'	lm1619		(Table 2, total men)
{%vname}(27) = -0		'	lm1617		(Table 2, total men)
{%vname}(28) = -0		'	lm1819		(Table 2, total men)
{%vname}(29) = 469		'	lm2024		(Table 2, total men)
{%vname}(30) = 531		'	lm2554		(Table 2, total men)
{%vname}(31) = 330		'	lm2534		(Table 2, total men)
{%vname}(32) = 115		'	lm3544		(Table 2, total men)
{%vname}(33) = 86		'	lm4554		(Table 2, total men)
{%vname}(34) = -66		'	lm5564		(Table 2, total men)
{%vname}(35) = -77		'	lm65o		(Table 2, total men)
				
{%vname}(36) = 14		'	lf16o		(Table 1; also Table 2, total women)
{%vname}(37) = -18		'	lf1619		(Table 2, total women)
{%vname}(38) = -9		'	lf1617		(Table 2, total women)
{%vname}(39) = -9		'	lf1819		(Table 2, total women)
{%vname}(40) = 374		'	lf2024		(Table 2, total women)
{%vname}(41) = -188		'	lf2554		(Table 2, total women)
{%vname}(42) = 14		'	lf2534		(Table 2, total women)
{%vname}(43) = -97		'	lf3544		(Table 2, total women)
{%vname}(44) = -106		'	lf4554		(Table 2, total women)
{%vname}(45) = -124		'	lf5564		(Table 2, total women)
{%vname}(46) = -30		'	lf65o		(Table 2, total women)
				
				
'Adjustment factors for Employed...
{%vname}(47) = 810		'	e16o		(Table 1)
				
{%vname}(48) = 812		'	em16o		(Table 1; also Table 2, total men)
{%vname}(49) = -0		'	em1619		(Table 2, total men)
{%vname}(50) = -0		'	em1617		(Table 2, total men)
{%vname}(51) = 0		'	em1819		(Table 2, total men)
{%vname}(52) = 437		'	em2024		(Table 2, total men)
{%vname}(53) = 514		'	em2554		(Table 2, total men)
{%vname}(54) = 318		'	em2534		(Table 2, total men)
{%vname}(55) = 113		'	em3544		(Table 2, total men)
{%vname}(56) = 84		'	em4554		(Table 2, total men)
{%vname}(57) = -64		'	em5564		(Table 2, total men)
{%vname}(58) = -75		'	em65o		(Table 2, total men)
				
{%vname}(59) = -2		'	ef16o		(Table 1; also Table 2, total women)
{%vname}(60) = -17		'	ef1619		(Table 2, total women)
{%vname}(61) = -8		'	ef1617		(Table 2, total women)
{%vname}(62) = -8		'	ef1819		(Table 2, total women)
{%vname}(63) = 351		'	ef2024		(Table 2, total women)
{%vname}(64) = -185		'	ef2554		(Table 2, total women)
{%vname}(65) = 12		'	ef2534		(Table 2, total women)
{%vname}(66) = -93		'	ef3544		(Table 2, total women)
{%vname}(67) = -104		'	ef4554		(Table 2, total women)
{%vname}(68) = -121		'	ef5564		(Table 2, total women)
{%vname}(69) = -30		'	ef65o		(Table 2, total women)
