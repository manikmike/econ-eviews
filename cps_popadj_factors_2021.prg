...
' This version of the program -- cps_popadj_factors_2021.prg -- adds the pop adjustment values released by BLS in Jan 2021 -- BLH 3-15-2021
...
!yr_latest = 2021		' latest year, pop controls for which are being added to the workfile
' BLS file containing the raw numbers for 2021:  \\s1f906b\econ\Data\Raw\CPS\Pop Adjustments\2021_Pop_effects_based_on_Dec2020.pdf


' file that holds the existing popadj factors
%old_file = "cps_popadj_2020" 	' name only
%old_file_path = "Z:\Data\Raw\CPS\PopAdjustments\CPS_PopAdj_Factors" + "\" + %old_file + ".wf1"	' full path
...
%new_file_path = "Z:\Data\Raw\CPS\PopAdjustments\CPS_PopAdj_Factors" + "\" + %new_file + ".wf1"	' full path
...
{%vname}(1) = -476		'	n16o			(Table 1; also Table 2)
				
{%vname}(2) = -224		'	nm16o		(Table 1; also Table 2, total men)
{%vname}(3) = -22			'	nm1619		(Table 2, total men)
{%vname}(4) = -10			'	nm1617		(Table 2, total men)
{%vname}(5) = -12			'	nm1819		(Table 2, total men)
{%vname}(6) = -32			'	nm2024		(Table 2, total men)
{%vname}(7) = -41			'	nm2554		(Table 2, total men)
{%vname}(8) = -21			'	nm2534		(Table 2, total men)
{%vname}(9) = -7			'	nm3544		(Table 2, total men)
{%vname}(10) = -13		'	nm4554		(Table 2, total men)
{%vname}(11) = -28		'	nm5564		(Table 2, total men)
{%vname}(12) = -101		'	nm65o		(Table 2, total men)
				
{%vname}(13) = -252		'	nf16o			(Table 1)
{%vname}(14) = -22		'	nf1619		(Table 2, total women)
{%vname}(15) = -12		'	nf1617		(Table 2, total women)
{%vname}(16) = -9			'	nf1819		(Table 2, total women)
{%vname}(17) = -30		'	nf2024		(Table 2, total women)
{%vname}(18) = -74		'	nf2554		(Table 2, total women)
{%vname}(19) = -38		'	nf2534		(Table 2, total women)
{%vname}(20) = -17		'	nf3544		(Table 2, total women)
{%vname}(21) = -20		'	nf4554		(Table 2, total women)
{%vname}(22) = -28		'	nf5564		(Table 2, total women)
{%vname}(23) = -98		'	nf65o			(Table 2, total women)
				
				
'Adjustment factors for Labor force...
{%vname}(24) = -199		'	l16o			(Table 1)
				
{%vname}(25) = -100		'	lm16o			(Table 1; also Table 2, total men)
{%vname}(26) = -6			'	lm1619		(Table 2, total men)
{%vname}(27) = -2			'	lm1617		(Table 2, total men)
{%vname}(28) = -4			'	lm1819		(Table 2, total men)
{%vname}(29) = -17		'	lm2024		(Table 2, total men)
{%vname}(30) = -37		'	lm2554		(Table 2, total men)
{%vname}(31) = -17		'	lm2534		(Table 2, total men)
{%vname}(32) = -8			'	lm3544		(Table 2, total men)
{%vname}(33) = -12		'	lm4554		(Table 2, total men)
{%vname}(34) = -20		'	lm5564		(Table 2, total men)
{%vname}(35) = -21		'	lm65o			(Table 2, total men)
				
{%vname}(36) = -99		'	lf16o			(Table 1; also Table 2, total women)
{%vname}(37) = -5			'	lf1619			(Table 2, total women)
{%vname}(38) = -1			'	lf1617			(Table 2, total women)
{%vname}(39) = -3			'	lf1819			(Table 2, total women)
{%vname}(40) = -17		'	lf2024			(Table 2, total women)
{%vname}(41) = -50		'	lf2554			(Table 2, total women)
{%vname}(42) = -26		'	lf2534			(Table 2, total women)
{%vname}(43) = -11		'	lf3544			(Table 2, total women)
{%vname}(44) = -14		'	lf4554			(Table 2, total women)
{%vname}(45) = -15		'	lf5564			(Table 2, total women)
{%vname}(46) = -11		'	lf65o			(Table 2, total women)
				
				
'Adjustment factors for Employed...
{%vname}(47) = -180		'	e16o			(Table 1)
				
{%vname}(48) = -91		'	em16o		(Table 1; also Table 2, total men)
{%vname}(49) = -5			'	em1619		(Table 2, total men)
{%vname}(50) = -2			'	em1617		(Table 2, total men)
{%vname}(51) = -3			'	em1819		(Table 2, total men)
{%vname}(52) = -15		'	em2024		(Table 2, total men)
{%vname}(53) = -34		'	em2554		(Table 2, total men)
{%vname}(54) = -16		'	em2534		(Table 2, total men)
{%vname}(55) = -7			'	em3544		(Table 2, total men)
{%vname}(56) = -10		'	em4554		(Table 2, total men)
{%vname}(57) = -18		'	em5564		(Table 2, total men)
{%vname}(58) = -19		'	em65o		(Table 2, total men)
				
{%vname}(59) = -88		'	ef16o			(Table 1; also Table 2, total women)
{%vname}(60) = -4			'	ef1619		(Table 2, total women)
{%vname}(61) = -1			'	ef1617		(Table 2, total women)
{%vname}(62) = -3			'	ef1819		(Table 2, total women)
{%vname}(63) = -16		'	ef2024		(Table 2, total women)
{%vname}(64) = -45		'	ef2554		(Table 2, total women)
{%vname}(65) = -23		'	ef2534		(Table 2, total women)
{%vname}(66) = -9			'	ef3544		(Table 2, total women)
{%vname}(67) = -13		'	ef4554		(Table 2, total women)
{%vname}(68) = -14		'	ef5564		(Table 2, total women)
