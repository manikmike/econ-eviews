...
' This version of the program -- cps_popadj_factors_2022.prg -- adds the pop adjustment values released by BLS in Jan 2022 -- SHS 7-29-2022
...
!yr_latest = 2022		' latest year, pop controls for which are being added to the workfile
' BLS file containing the raw numbers for 2022:  \\s1f906b\econ\Data\Raw\CPS\Pop Adjustments\2022_Pop_effects_based_on_Dec2021.pdf


' file that holds the existing popadj factors
%old_file = "cps_popadj_2021" 	' name only
%old_file_path = "\\s1f906b\econ\Data\Raw\CPS\PopAdjustments\CPS_PopAdj_Factors" + "\" + %old_file + ".wf1"	' full path
...
%new_file_path = "\\s1f906b\econ\Data\Raw\CPS\PopAdjustments\CPS_PopAdj_Factors" + "\" + %new_file + ".wf1"	' full path
...
{%vname}(1) = 974		'	n16o		(Table 1; also Table 2)
				
{%vname}(2) = 1359		'	nm16o		(Table 1; also Table 2, total men)
{%vname}(3) = 311		'	nm1619		(Table 2, total men)
{%vname}(4) = 168		'	nm1617		(Table 2, total men)
{%vname}(5) = 143		'	nm1819		(Table 2, total men)
{%vname}(6) = 52		'	nm2024		(Table 2, total men)
{%vname}(7) = 778		'	nm2554		(Table 2, total men)
{%vname}(8) = -313		'	nm2534		(Table 2, total men)
{%vname}(9) = 531		'	nm3544		(Table 2, total men)
{%vname}(10) = 560		'	nm4554		(Table 2, total men)
{%vname}(11) = 586		'	nm5564		(Table 2, total men)
{%vname}(12) = -367		'	nm65o		(Table 2, total men)
				
{%vname}(13) = -386		'	nf16o		(Table 1; also Table 2, total women)
{%vname}(14) = 258		'	nf1619		(Table 2, total women)
{%vname}(15) = 143		'	nf1617		(Table 2, total women)
{%vname}(16) = 114		'	nf1819		(Table 2, total women)
{%vname}(17) = 69		'	nf2024		(Table 2, total women)
{%vname}(18) = 252		'	nf2554		(Table 2, total women)
{%vname}(19) = -104		'	nf2534		(Table 2, total women)
{%vname}(20) = 237		'	nf3544		(Table 2, total women)
{%vname}(21) = 118		'	nf4554		(Table 2, total women)
{%vname}(22) = 92		'	nf5564		(Table 2, total women)
{%vname}(23) = -1057	'	nf65o		(Table 2, total women)
				
				
'Adjustment factors for Labor force...
{%vname}(24) = 1530		'	l16o		(Table 1)
				
{%vname}(25) = 1239		'	lm16o		(Table 1; also Table 2, total men)
{%vname}(26) = 106		'	lm1619		(Table 2, total men)
{%vname}(27) = 37		'	lm1617		(Table 2, total men)
{%vname}(28) = 69		'	lm1819		(Table 2, total men)
{%vname}(29) = 33		'	lm2024		(Table 2, total men)
{%vname}(30) = 688		'	lm2554		(Table 2, total men)
{%vname}(31) = -273		'	lm2534		(Table 2, total men)
{%vname}(32) = 475		'	lm3544		(Table 2, total men)
{%vname}(33) = 486		'	lm4554		(Table 2, total men)
{%vname}(34) = 415		'	lm5564		(Table 2, total men)
{%vname}(35) = -2		'	lm65o		(Table 2, total men)
				
{%vname}(36) = 291		'	lf16o		(Table 1; also Table 2, total women)
{%vname}(37) = 92		'	lf1619		(Table 2, total women)
{%vname}(38) = 38		'	lf1617		(Table 2, total women)
{%vname}(39) = 54		'	lf1819		(Table 2, total women)
{%vname}(40) = 45		'	lf2024		(Table 2, total women)
{%vname}(41) = 186		'	lf2554		(Table 2, total women)
{%vname}(42) = -81		'	lf2534		(Table 2, total women)
{%vname}(43) = 181		'	lf3544		(Table 2, total women)
{%vname}(44) = 87		'	lf4554		(Table 2, total women)
{%vname}(45) = 65		'	lf5564		(Table 2, total women)
{%vname}(46) = -98		'	lf65o		(Table 2, total women)
				
				
'Adjustment factors for Employed...
{%vname}(47) = 1471		'	e16o		(Table 1)
				
{%vname}(48) = 1198		'	em16o		(Table 1; also Table 2, total men)
{%vname}(49) = 96		'	em1619		(Table 2, total men)
{%vname}(50) = 33		'	em1617		(Table 2, total men)
{%vname}(51) = 63		'	em1819		(Table 2, total men)
{%vname}(52) = 28		'	em2024		(Table 2, total men)
{%vname}(53) = 671		'	em2554		(Table 2, total men)
{%vname}(54) = -261		'	em2534		(Table 2, total men)
{%vname}(55) = 459		'	em3544		(Table 2, total men)
{%vname}(56) = 474		'	em4554		(Table 2, total men)
{%vname}(57) = 405		'	em5564		(Table 2, total men)
{%vname}(58) = -2		'	em65o		(Table 2, total men)
				
{%vname}(59) = 273		'	ef16o		(Table 1; also Table 2, total women)
{%vname}(60) = 84		'	ef1619		(Table 2, total women)
{%vname}(61) = 35		'	ef1617		(Table 2, total women)
{%vname}(62) = 50		'	ef1819		(Table 2, total women)
{%vname}(63) = 42		'	ef2024		(Table 2, total women)
{%vname}(64) = 181		'	ef2554		(Table 2, total women)
{%vname}(65) = -80		'	ef2534		(Table 2, total women)
{%vname}(66) = 176		'	ef3544		(Table 2, total women)
{%vname}(67) = 84		'	ef4554		(Table 2, total women)
{%vname}(68) = 63		'	ef5564		(Table 2, total women)
{%vname}(69) = -97		'	ef65o		(Table 2, total women)
